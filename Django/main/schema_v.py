...
def schema_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": "Success", "data": []}

        # Update spider command for Vancouver houses
        cmd = f"cd /app/spider && scrapy crawl vancouver_house -a database=vancouver2025"
        os.system(cmd)
